    ...
    <body><div class="principal">    
            ...
            <section class="productos">
                <div id="libros">
                    ...
                    <br>
                    <form method="post" action="GrabarCategoria">
                        <table>
                            <tr>
                                <td>Categoria<input name="id" type="hidden" value="${p.idcategoria}"><br></td>
                                <td><input name="p" type="text"  class="form-control" value="${p.categoria}"><br></td>
                            </tr>
                        </table>
