...
<html>
    ...
    <body><div class="principal">    
            ...
            <section class="productos">
                <div id="libros">
                    <h1>Lista de Género</h1>
                    <% ArrayList<Genero> lista = (ArrayList<Genero>) request.getAttribute("lista"); %>
                    <table class="table table-responsive">
                        <tr>
                            <td>ID</td>
                            <td>Género</td>
                            <td>Categoría</td>
                            <td colspan="2"><a href="NewGenero">Nuevo</a></td>
                        </tr>
                        <% for (Genero x : lista) {%>
                        <tr>
                            <td><%=x.getIdgenero()%></td>
                            ...
                            <td><a href="EditarGenero?id=<%=x.getIdgenero()%>">Editar</a></td>
                            <td><a href="EliminarGenero?id=<%=x.getIdgenero()%>">Eliminar</a></td>
                        </tr>
                        <%}%>
                    </table>
                </div>
