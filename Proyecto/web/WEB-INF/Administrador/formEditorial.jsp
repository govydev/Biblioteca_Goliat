    ...
    <body><div class="principal">    
            ...
            <section class="productos">
                <div id="libros">
                    ...
                    <br>
                    <form method="post" action="GrabarEditorial">
                        <table>
                            <tr>
                                <td>Editorial<input name="id" type="hidden" value="${e.ideditorial}"><br></td>
                                <td><input name="e" type="text"  class="form-control" value="${e.editorial}"><br></td>
                            </tr>
                        </table>
