    ...
    <body><div class="principal">    
            ...
            <section class="productos">
                <div id="libros">
                    ...
                    <% ArrayList<Editorial> lista = (ArrayList<Editorial>) request.getAttribute("lista"); %>
                    <table class="table table-responsive">
                        <tr>
                            <td>ID</td>
                            <td>Editorial</td>
                            <td colspan="2"><a href="NuevoEditorial">Nuevo</a></td>
                        </tr>
                        <% for (Editorial x : lista) {%>
                        <tr>
                            <td><%=x.getIdeditorial()%></td>
                            <td><%=x.getEditorial()%></td>
                            <td><a href="EditarEditorial?id=<%=x.getIdeditorial()%>">Editar</a></td>
                            <td><a href="EliminarEditorial?id=<%=x.getIdeditorial()%>">Eliminar</a></td>
                        </tr>
                        <%}%>
                    </table>
                </div>
