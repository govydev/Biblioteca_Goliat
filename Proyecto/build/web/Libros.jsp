<%@page import="biblioteca.DAO.ProductoDAO"%>
        ...
        <div class="principal">    
            ...
            <nav class="navegador">
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="active"><a href="Libros">Libros</a></li>
            ...
            <section class="productos">
                <table id="libros">
                    <%ArrayList<Producto> lista = (ArrayList<Producto>) request.getAttribute("libros");%>
                    ...
                    <tr>
                        ...
                        <th width="70%" align="left">
                            <h3 align="center"><a href="LibroWebG?id=<%=p.getIdproducto()%>"><%=p.getTitulo()%></a></h3><br>
