                ...
                <div id="libros">
                    ...
                    <table class="table table-responsive">
                        <tr>
                            <td>ID</td>
                            <td>Categoria</td>
                            <td colspan="2"><a href="NuevaCategoria">Nuevo</a></td>
                        </tr>
                        <% for (Categoria x : lista) {%>
                        <tr>
                            <td><%=x.getIdcategoria()%></td>
                            <td><%=x.getCategoria()%></td>
                            <td><a href="EditarCategoria?id=<%=x.getIdcategoria()%>">Editar</a></td>
                            <td><a href="EliminarCategoria?id=<%=x.getIdcategoria()%>">Eliminar</a></td>
                        </tr>
                        <%}%>
                    </table>
                </div>
